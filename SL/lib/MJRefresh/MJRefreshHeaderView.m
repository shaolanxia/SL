...
- (void)setScrollView:(UIScrollView *)scrollView
{
    ...
    // 1.设置边框
    self.frame = CGRectMake(0, - MJRefreshViewHeight, scrollView.frame.size.width+40, MJRefreshViewHeight);
...
- (void)updateTimeLabel
{
    ...
    // 3.显示日期
    _lastUpdateTimeLabel.text = [NSString stringWithFormat:@"最后刷新时间 : %@", time];//Last Updated
}
